...
void main()
{
    ...
    printf("Orden Reverso\n");
    verListaReverse(&lista);

    printf("Ordenada mediante ordenarListaB\n");
    SelectionSortB(&lista);
    verLista(&lista);
    verListaReverse(&lista); //la muestro reverse para verificar los enlaces
}
